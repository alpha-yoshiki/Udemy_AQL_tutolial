...
class Customer(db.Model):
    ...
    purchases = db.relationship(
        "Purchase", backref="customers", cascade="delete")
...
class Item(db.Model):
    ...
    purchase_details = db.relationship(
        "Purchase_detail", backref="items", cascade="delete")
